...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      {/* Static ocean/forest glow effect */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-kenai-teal/20 rounded-full blur-3xl opacity-60" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-kenai-deep/15 rounded-full blur-3xl opacity-50" />
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8 opacity-0 animate-slide-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
            <Link to="/regions" className="group">
              <div className="bg-glass rounded-lg p-4 md:p-5 transition-all duration-300 hover:scale-105 hover:bg-primary/10 border border-border/50 hover:border-primary/50">
                ...
                <span className="font-display text-xs md:text-sm text-foreground block">Explore by Area</span>
              </div>
            </Link>
            <Link to="/categories" className="group">
              <div className="bg-glass rounded-lg p-4 md:p-5 transition-all duration-300 hover:scale-105 hover:bg-primary/10 border border-border/50 hover:border-primary/50">
                <Grid3X3 className="w-6 h-6 md:w-8 md:h-8 mx-auto mb-2 text-kenai-gold group-hover:animate-float" />
            ...
            <Link to="/browse" className="group">
              <div className="bg-glass rounded-lg p-4 md:p-5 transition-all duration-300 hover:scale-105 hover:bg-primary/10 border border-border/50 hover:border-primary/50">
                <Search className="w-6 h-6 md:w-8 md:h-8 mx-auto mb-2 text-kenai-ocean group-hover:animate-float" />
          ...
          <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto mt-10 opacity-0 animate-fade-in" style={{ animationDelay: '1000ms', animationFillMode: 'forwards' }}>
            <div>
              ...
              <div className="text-muted-foreground text-xs">Category Sites</div>
            </div>
            <div>
              <div className="font-display text-xl md:text-2xl font-bold text-foreground">9</div>
              <div className="text-muted-foreground text-xs">Local Areas</div>
            </div>
            <div>
